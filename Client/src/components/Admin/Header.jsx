...
//   useEffect(() => {
//     if (profile) {
//       // Initialize online status from profile data
//       dispatch(setOnlineStatus(profile.online));
//       localStorage.setItem('onlineStatus', JSON.stringify(profile.online));
//     }
//   }, [profile, dispatch]);
...
//           await updateStatus({ online: newStatus }).unwrap();
...
//     useEffect(() => {
//         const savedStatus = JSON.parse(localStorage.getItem('onlineStatus'));
//         if (savedStatus !== null) {
//             dispatch(toggleOnlineStatus(savedStatus)); // Initialize state from local storage
//         }
//     }, [dispatch]);
